      ...
      <main className="flex-1">
        <div className="max-w-3xl mx-auto px-6 py-12">
          ...
          <p className="text-muted-foreground mb-10">
            A demonstration of AI deployment and enablement capabilities using OpenAI GPT models and Codex workflows.
          </p>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-3">
              <a
                href="https://github.com/christiantcurran-collab/cc"
                target="_blank"
              ...
              >
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Financial services AI use cases powered by OpenAI GPT and Codex tooling</div>
                </div>
