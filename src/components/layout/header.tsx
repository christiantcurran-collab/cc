      ...
      <div className="flex h-14 items-center px-6">
        <Link href="/" className="flex items-center gap-2 mr-8">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-bold leading-tight">CTC Portfolio</span>
            <span className="text-[10px] text-muted-foreground leading-tight">GPT and Codex demos</span>
          </div>
        </Link>
